...
Aktuell: `0.2.35 - Remote-Modboard MariaDB Media Index Plan No Code`.
...
- 0.2.35 ist ein No-Code Architekturplan fuer spaetere MariaDB Media-Index-Arbeit.
...
0.2.35 aendert keine Runtime-Dateien
```
