...
## RDAP / Remote-Modboard Media Index Tombstone Preview

- `remote-modboard/backend/src/routes/media-index-diff.routes.js`
  - Route: `GET /api/remote/media/index/diff/status`
  - Neue Route: `GET /api/remote/media/index/tombstone/persistent/preview`
  - Stand: `RDAP_0.2.58P_MEDIA_INDEX_PERSISTENT_TOMBSTONE_GATED_PREVIEW`
  - Status: read-only, keine Writes, keine Execute-Route, kein physisches Loeschen, kein Online->Agent-Trigger.
