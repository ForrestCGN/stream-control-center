...
## Externe Live-Konfiguration ausserhalb des Repos

```text
ISPConfig/Nginx fuer mods.forrestcgn.de:
- separater location /agent-ws Block ergaenzt
- proxy_pass http://127.0.0.1:3010/agent-ws
- WebSocket Upgrade/Connection Header gesetzt
```

## Relevant fuer naechsten Step RDAP101
