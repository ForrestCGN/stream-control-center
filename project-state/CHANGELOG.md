...
- `/api/remote/routes` meldet:
  - `statusApiVersion = rdap_admin_note_write38.v1`
  - `adminNoteWritePlan.prepared = true`
- `/api/remote/admin/users/admin-notes/write-plan` bestaetigt:
  - `ok = true`
  - `readOnly = true`
...
- RDAP38 bestaetigt RDAP39-Plan:
  - Permission: `admin.users.note.write`
  - Confirm: nur JSON-Body
  - Audit erforderlich
  - Lock erforderlich
  - Backup vor erstem produktivem Write erforderlich
