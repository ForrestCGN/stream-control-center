...
Stand: 2026-06-18 – EVS52.16b

## Sofort nach Deploy testen

- Beendetes Event mit Ranking auswählen.
- Prüfen, ob `Auswertung starten` direkt im Buttonblock neben den Event-Aktionen erscheint.
- Button klicken und Winner-Overlay beobachten.
