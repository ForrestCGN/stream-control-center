...
```text
0.2.20 - OBS Allowlist-/Rechte-Modell read-only planen/vorbereiten
```
...
- Admin/Diagnose nimmt spaeter Technikdetails auf: Agent, Inventarstatus, ENV-Diagnose, interne Szenen, komplette Quellenliste
