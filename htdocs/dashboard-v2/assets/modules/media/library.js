...
(function registerMediaLibraryModule() {
  ...
  function renderInventoryTable() {
    ...
    if (!inventory.active) {
      return '<div class="admin-lock-note"><i>i</i><div><strong>Noch keine lokale Medienliste aktiv.</strong><span>Online wartet auf Agent-Sync. Lokal wird das Inventar nur angezeigt, wenn die lokalen Medienordner erreichbar sind.</span></div></div>';
    }
    if (!items.length) {
