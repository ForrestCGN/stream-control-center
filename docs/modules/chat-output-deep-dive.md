# Chat Output Deep Dive

Stand: 2026-05-26  
Quelle: `backend/modules/chat_output.js` aus dem aktuellen Backend-Upload.  
Kategorie: `chat-control`

## Zweck

Schmale Chat-Ausgabe-API für Status, Send und Reload.
...
- Auth/Target-Regeln prüfen, bevor produktive Chat-Ausgaben darüber laufen.
