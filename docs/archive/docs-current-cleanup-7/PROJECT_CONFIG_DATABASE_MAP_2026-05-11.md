...
## STEP260 DeathCounter DB-Storage STABLE Update

DeathCounter V2 nutzt produktiv DB-Storage. Die vorhandene JSON-Datei bleibt nur Backup-/Exportformat.
...
- Schema wurde sanft vorbereitet.
- Automatischer JSON-Dual-Write ist aus.
- JSON darf als Backup/Export bleiben, ist aber nicht mehr produktive Quelle.
