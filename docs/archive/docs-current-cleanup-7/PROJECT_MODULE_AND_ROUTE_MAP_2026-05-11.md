...
|deathcounter_v2|37 live bestätigt|35+ Strings|/api/deathcounter/v2/storage/backup, /api/deathcounter/v2/storage/export, /api/deathcounter/v2/storage/consistency, /api/deathcounter/v2/storage/read-test, /api/deathcounter/v2/integration-check|
...
## STEP260 DeathCounter Route Update

Die DeathCounter-Route-Map wurde nach Live-Test ergänzt. `integration-check` meldete nach STEP259/STEP260 `routes: 37`.

Final relevante Storage-/Backup-Routen:
...
Command-Erweiterungen über `/api/deathcounter/v2/command`:
