# DOCS_CLEANUP_6_SECOND_PASS_AUDIT

Stand: 2026-06-27  
Step: `RDAP_DOCS_CLEANUP_6_DOCS_CURRENT_SECOND_PASS`  
Branch/Truth: GitHub/dev + lokaler Snapshot aus `D:\Git\stream-control-center`.

## Zweck

Second-Pass-Audit nach RDAP Docs Cleanup 5. Dieser Step prueft den verbliebenen Bestand in `docs/current/`, klassifiziert ihn grob und stellt einen sicheren Folgeplan bereit.

## Wichtigster Befund

Die Datei `docs/current/RDAP_EXAKTE_ARBEITSWEISE_2026-06-25_RDAP28_WORKFLOW.md` war in Cleanup 5 als `KEEP_CURRENT` vorgesehen, liegt aber im aktuellen Snapshot nicht mehr unter `docs/current/`. Sie wurde unter `docs/archive/docs-current-cleanup-5/RDAP_EXAKTE_ARBEITSWEISE_2026-06-25_RDAP28_WORKFLOW.md` gefunden.

Dieser Step stellt die Datei deshalb wieder unter `docs/current/` bereit. Die Archivkopie bleibt als historische Kopie unveraendert erhalten.

## Zaehnung nach Restore-Annahme

| Kategorie | Anzahl |
| --- | ---: |
| KEEP_CURRENT | 15 |
| ARCHIVE_OR_MERGE | 1033 |
| DELETE_OR_REGENERATE | 0 |
| REVIEW_MANUALLY | 40 |

Gesamt klassifiziert: **1088** Dateien.

## Klassifizierungsregeln

- `KEEP_CURRENT`: aktuelle Start-, Master-, Arbeitsweise-, Remote-Modboard-, Roadmap-, Konsolidierungs- und Cleanup-6-Dateien.
- `ARCHIVE_OR_MERGE`: klar historische Handoffs, CAN-/Step-/Prompt-/Diagnose-/alte Cleanup-Dateien oder Doku, die in zentrale Current-Dokumente ueberfuehrt werden sollte.
- `DELETE_OR_REGENERATE`: in diesem Step bewusst leer. Es gibt keine harten Deletes.
- `REVIEW_MANUALLY`: Restbestand, der vor Move/Delete fachlich gelesen werden muss.

## Grenzen

- Keine Codeaenderung.
- Keine DB-Aenderung.
- Keine Runtime-/Remote-Modboard-Writes.
- Kein Webserver-Deploy.
- Keine Loeschung.
- Keine automatische Behandlung der grossen `REVIEW_MANUALLY`-Menge.

## Exakte Listen

<details>
<summary>KEEP_CURRENT (15)</summary>
...
<details>
<summary>ARCHIVE_OR_MERGE (1033)</summary>
...
docs/current/BIRTHDAY_STATUS_DIAGNOSTICS_CAN42_18.md
docs/current/BIRTHDAY_SYSTEM_STATUS.md
docs/current/BUS_TWITCH_ARCHITECTURE.md
...
docs/current/CAN-42.21d_dashboard_diagnostics_integrated_registry_fix.md
docs/current/CAN-42.22_diagnostics_file_inventory.md
docs/current/CAN-42.23_diagnostics_cleanup_1.md
docs/current/CAN-42.24_diagnostics_integrated_details_cleanup.md
docs/current/CAN-42.25_dashboard_diagnostics_cleanup_candidates.md
docs/current/CAN-42.26_diagnostics_registry_plan.md
docs/current/CAN-42.27_diagnostics_registry_endpoint.md
docs/current/CAN-42.28_diagnostics_registry_coverage.md
docs/current/CAN-42.28b_diagnostics_registry_coverage_normalization_fix.md
docs/current/CAN-42.29_dashboard_diagnostics_registry_coverage_display.md
docs/current/CAN-42.30_dashboard_diagnostics_old_file_cleanup.md
docs/current/CAN-42.31_diagnostics_cleanup_sync_verification.md
docs/current/CAN-42.32_diagnostics_documentation_new_module_rules.md
docs/current/CAN-42.33_dashboard_loaded_extensions_inventory.md
docs/current/CAN-42.34_loaded_dashboard_extensions_review.md
docs/current/CAN-42.35_dashboard_extensions_documentation.md
...
docs/current/CAN-43.1_documentation_handoff.md
...
docs/current/CAN44_10_AUTOSHOUTOUT_LIVE_SAFETY_FIX.md
docs/current/CAN44_11_1_TWITCH_STREAM_DEBUG_FALLBACK.md
docs/current/CAN44_12_1_LIVE_STATUS_MONITOR_ROUTE_FIX.md
docs/current/CAN44_12_2_LIVE_STATUS_MONITOR_LOGS_FIX.md
docs/current/CAN44_12_LIVE_STATUS_MONITOR.md
docs/current/CAN44_13_1_AUTOSHOUTOUT_DRYRUN_CLEAR_TARGET.md
docs/current/CAN44_13_2_AUTOSHOUTOUT_CLEAR_TARGET_PARAM_FIX.md
docs/current/CAN44_13_3_AUTOSHOUTOUT_CLEAR_TARGET_DISPLAY_PARAM_FIX.md
docs/current/CAN44_13_4_AUTOSHOUTOUT_DOCUMENTATION.md
docs/current/CAN44_13_5_DOCS_MODULES_INDEX_UPDATE.md
docs/current/CAN44_13_AUTOSHOUTOUT_MESSAGE_THRESHOLD_GREETING.md
docs/current/CAN44_14_SHOUTOUT_DASHBOARD_STRUCTURE_PLAN.md
docs/current/CAN44_15_SHOUTOUT_SYSTEM_STANDARDS_ALIGNMENT.md
docs/current/CAN44_16_README.md
docs/current/CAN44_16_SHOUTOUT_TEXT_INVENTORY_MIGRATION_PLAN.md
docs/current/CAN44_17_README.md
...
docs/current/CAN44_19_3_README.md
...
docs/current/CAN44_20_2_SHOUTOUT_DASHBOARD_TAB_REORG.md
docs/current/CAN44_21_16_TWITCH_CLIP_SOUND_QUEUE.md
docs/current/CAN44_21_17_TWITCH_CLIP_OVERLAY_PLAYBACK_FIX.md
docs/current/CAN44_21_18_TWITCH_CLIP_OVERLAY_SYNTAX_FIX.md
docs/current/CAN44_21_19_TWITCH_CLIP_STANDALONE_IFRAME.md
docs/current/CAN44_21_20_CLIP_PLAYER_GQL_DIAG_FIX.md
docs/current/CAN44_21_21_TWITCH_CLIP_DIRECT_SOUND_OVERLAY.md
docs/current/CAN44_21_22_TWITCH_CLIP_NO_PREFLASH.md
docs/current/CAN44_21_23_TWITCH_CLIP_SILENT_RESET.md
docs/current/CAN44_21_24_QUEUE_CHAT_FEEDBACK.md
docs/current/CAN44_21_25_QUEUE_TEST_ROUTINE.md
docs/current/CAN44_21_26_COMMAND_INTAKE_TRACE.md
docs/current/CAN44_21_27_SO_QUEUE_CONTRACT_OFFICIAL_COUPLING.md
docs/current/CAN44_21_34_STABLE_TEST_REPORT.md
docs/current/CAN44_21_NEXT_STEPS_AFTER_DIRECT_INTAKE_STABLE.md
docs/current/CAN44_27_AUTO_SHOUTOUT_BUS_README.md
docs/current/CAN44_29_AUTO_SHOUTOUT_LOYALTY_STYLE_BUS.md
docs/current/CAN44_2_AUTO_SHOUTOUT_DASHBOARD.md
docs/current/CAN44_30_AUTOSHOUTOUT_ACTIVITY_MODAL_README.md
docs/current/CAN44_31_AUTOSHOUTOUT_V2_ACTIVITY_BRIDGE_README.md
docs/current/CAN44_3_AUTO_SHOUTOUT_UX_SCENE_GATE.md
docs/current/CAN44_4_1_DASHBOARD_EMERGENCY_FIX.md
docs/current/CAN44_4_SHOUTOUT_DASHBOARD_INTEGRATION_REFRESH_FIX.md
docs/current/CAN44_6_1_AUTOSHOUTOUT_TAB_STABILITY_HOTFIX.md
docs/current/CAN44_6_AUTOSHOUTOUT_AS_SHOUTOUT_TAB.md
docs/current/CAN44_7_AUTOSHOUTOUT_ANTI_SPAM.md
docs/current/CAN44_8_1_AUTOSHOUTOUT_RESET_DAY_PARAM_FIX.md
docs/current/CAN44_8_AUTOSHOUTOUT_RESET_DAY_FIX.md
docs/current/CAN44_9_AUTOSHOUTOUT_IMMEDIATE_MESSAGE_FIX.md
docs/current/CAN44_AUTOSHOUTOUT_ROUTES_DB_STATUS.md
docs/current/CAN44_AUTO_SHOUTOUT_BACKEND.md
...
docs/current/CURRENT_CHAT_HANDOFF.md
docs/current/CURRENT_CHAT_HANDOFF_AFTER_CAN43_FEATURE_WORK.md
docs/current/CURRENT_CHAT_HANDOFF_ALERT_TIERS_1_1_2026-06-10.md
docs/current/CURRENT_CHAT_HANDOFF_ALERT_TIERS_2026-06-09.md
docs/current/CURRENT_CHAT_HANDOFF_AUTOSHOUT_HOTFIX_2026_06_09.md
docs/current/CURRENT_CHAT_HANDOFF_BIRTHDAY_DASHBOARD_USERPARTY_PLAY.md
docs/current/CURRENT_CHAT_HANDOFF_BIRTHDAY_PARTY_IMAGE_HIDE_TEXT_CARD.md
docs/current/CURRENT_CHAT_HANDOFF_BIRTHDAY_PARTY_IMAGE_LAYOUT_COMPACT_FIX.md
docs/current/CURRENT_CHAT_HANDOFF_BIRTHDAY_PARTY_IMAGE_MEDIA_FIELD.md
docs/current/CURRENT_CHAT_HANDOFF_BIRTHDAY_PARTY_IMAGE_VISIBLE_FIX.md
docs/current/CURRENT_CHAT_HANDOFF_BIRTHDAY_PARTY_SONG_MEDIAID_FIX.md
...
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_10.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_11.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_12.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_13.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_14.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_14B.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_15.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_15B.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_16.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_16B.md
...
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_5.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_5B.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_6.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_7.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_8.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_8B.md
docs/current/CURRENT_CHAT_HANDOFF_BUS_TWITCH_9.md
docs/current/CURRENT_CHAT_HANDOFF_CAN10_0.md
docs/current/CURRENT_CHAT_HANDOFF_CAN10_1.md
docs/current/CURRENT_CHAT_HANDOFF_CAN10_2.md
docs/current/CURRENT_CHAT_HANDOFF_CAN10_3.md
docs/current/CURRENT_CHAT_HANDOFF_CAN10_4.md
docs/current/CURRENT_CHAT_HANDOFF_CAN10_5.md
docs/current/CURRENT_CHAT_HANDOFF_CAN10_6.md
docs/current/CURRENT_CHAT_HANDOFF_CAN10_7.md
docs/current/CURRENT_CHAT_HANDOFF_CAN11_0.md
docs/current/CURRENT_CHAT_HANDOFF_CAN11_1.md
docs/current/CURRENT_CHAT_HANDOFF_CAN11_2.md
docs/current/CURRENT_CHAT_HANDOFF_CAN11_3.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN12_1.md
docs/current/CURRENT_CHAT_HANDOFF_CAN12_2.md
docs/current/CURRENT_CHAT_HANDOFF_CAN12_3.md
docs/current/CURRENT_CHAT_HANDOFF_CAN12_4.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN15_3.md
docs/current/CURRENT_CHAT_HANDOFF_CAN15_4.md
docs/current/CURRENT_CHAT_HANDOFF_CAN15_5.md
docs/current/CURRENT_CHAT_HANDOFF_CAN15_6_FINAL.md
docs/current/CURRENT_CHAT_HANDOFF_CAN16_0.md
docs/current/CURRENT_CHAT_HANDOFF_CAN16_1.md
docs/current/CURRENT_CHAT_HANDOFF_CAN16_2.md
docs/current/CURRENT_CHAT_HANDOFF_CAN16_3.md
docs/current/CURRENT_CHAT_HANDOFF_CAN16_4_FINAL.md
docs/current/CURRENT_CHAT_HANDOFF_CAN17_0.md
docs/current/CURRENT_CHAT_HANDOFF_CAN17_1.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN18_1.md
docs/current/CURRENT_CHAT_HANDOFF_CAN18_2.md
docs/current/CURRENT_CHAT_HANDOFF_CAN18_3_FINAL.md
docs/current/CURRENT_CHAT_HANDOFF_CAN19_0.md
docs/current/CURRENT_CHAT_HANDOFF_CAN19_1.md
docs/current/CURRENT_CHAT_HANDOFF_CAN19_2.md
docs/current/CURRENT_CHAT_HANDOFF_CAN19_3.md
docs/current/CURRENT_CHAT_HANDOFF_CAN19_4_FINAL.md
docs/current/CURRENT_CHAT_HANDOFF_CAN20_0.md
docs/current/CURRENT_CHAT_HANDOFF_CAN20_1.md
docs/current/CURRENT_CHAT_HANDOFF_CAN20_2_FINAL.md
docs/current/CURRENT_CHAT_HANDOFF_CAN21_0.md
docs/current/CURRENT_CHAT_HANDOFF_CAN21_1.md
docs/current/CURRENT_CHAT_HANDOFF_CAN21_2_FINAL.md
docs/current/CURRENT_CHAT_HANDOFF_CAN22_0.md
docs/current/CURRENT_CHAT_HANDOFF_CAN22_1.md
docs/current/CURRENT_CHAT_HANDOFF_CAN22_2.md
docs/current/CURRENT_CHAT_HANDOFF_CAN22_3.md
docs/current/CURRENT_CHAT_HANDOFF_CAN22_4.md
docs/current/CURRENT_CHAT_HANDOFF_CAN22_5_FINAL.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_1.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_10.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_11.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_12.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_13.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_14.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN23_2.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_3.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_4.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_5.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_6.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_7.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_8.md
docs/current/CURRENT_CHAT_HANDOFF_CAN23_9.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN24_3.md
docs/current/CURRENT_CHAT_HANDOFF_CAN24_4.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN24_9.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN32_2.md
docs/current/CURRENT_CHAT_HANDOFF_CAN33_2.md
docs/current/CURRENT_CHAT_HANDOFF_CAN33_3.md
docs/current/CURRENT_CHAT_HANDOFF_CAN33_4.md
docs/current/CURRENT_CHAT_HANDOFF_CAN34_2.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN35_2.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN42_15.md
docs/current/CURRENT_CHAT_HANDOFF_CAN42_16.md
docs/current/CURRENT_CHAT_HANDOFF_CAN42_17.md
docs/current/CURRENT_CHAT_HANDOFF_CAN42_18.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN42_21B.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN42_35.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN43_1.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN44_21_SHOUTOUT.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_21_SHOUTOUT_DIRECT_INTAKE_STABLE.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_21_SHOUTOUT_FINAL.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_21_SHOUTOUT_PLAYBACK.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_25_SHOUTOUT_TEXTS.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_26_SHOUTOUT_OVERLAY_SETS.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_27_SHOUTOUT_DASHBOARD_UI.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_30_SHOUTOUT_OVERLAY_SETS_VISIBLE_FIX.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_31_AUTOSHOUTOUT_BUS_DASHBOARD.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_31_SHOUTOUT_OVERLAY_SETS_COMPACT_UI.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_32_AUTOSHOUTOUT_STREAMDAY_RELIABILITY.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_33_AUTOSHOUTOUT_SETTINGS_TRUTH_FIX.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_34_TWITCH_STREAM_BUS_EVENTS.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_35_TWITCH_EVENTS_STREAM_STATE_PROVIDER.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_36_AUTOSHOUTOUT_STREAM_BUS_CONSUMER.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_37_STREAM_SESSION_AUTHORITY.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_38_STREAM_SESSION_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_39_PENDING_EVENT_GUARD.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_40_DASHBOARD_STREAM_STATE_OVERRIDE_CONTROLS.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_41_MANUAL_OVERRIDE_LOCK_FIX.md
docs/current/CURRENT_CHAT_HANDOFF_CAN44_42_DASHBOARD_EFFECTIVE_STREAM_STATE_DISPLAY.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN8_13.md
...
docs/current/CURRENT_CHAT_HANDOFF_CAN9_2.md
docs/current/CURRENT_CHAT_HANDOFF_CAN9_3.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVENT_RUNTIME_2D.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_RUNTIME_2E.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_RUNTIME_2F.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_RUNTIME_2G.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_1.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_2.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_3.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_3B.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_3C.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_4.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_4B.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_4C.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_4D.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_5.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_5B.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SOUND_5C.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SYSTEM_EVS43_DOCUMENTED.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SYSTEM_EVS44_DOCUMENTED.md
docs/current/CURRENT_CHAT_HANDOFF_EVENT_SYSTEM_EVS49_12.md
docs/current/CURRENT_CHAT_HANDOFF_EVS50_1_POINT_HISTORY.md
docs/current/CURRENT_CHAT_HANDOFF_EVS50_2_POINTS_CHECK.md
docs/current/CURRENT_CHAT_HANDOFF_EVS50_3_POINTS_CHECK_INSERT_FIX.md
docs/current/CURRENT_CHAT_HANDOFF_EVS50_4_POINTS_CHECK_SOUND_FIX.md
docs/current/CURRENT_CHAT_HANDOFF_EVS50_5_POINTS_CHECK_ACTIVE_EVENT_FIX.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS51_2_TEXT_CHECK_WRONG_FIX.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS51_5_TEXT_ANSWERS_OPTIONAL_FIX.md
docs/current/CURRENT_CHAT_HANDOFF_EVS51_6_START_AUTO_SOUND_PLAN.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS52_16B_VISIBLE_FINALE_BUTTON.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS52_17_WINNER_OVERLAY_IDLE_HIDE.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS52_1_RUNTIME_TEXT_STATUS_OVERLAY.md
docs/current/CURRENT_CHAT_HANDOFF_EVS52_20_WINNER_FINALE_NO_RESTART_LOOP.md
docs/current/CURRENT_CHAT_HANDOFF_EVS52_21_NEXT_MODULE.md
docs/current/CURRENT_CHAT_HANDOFF_EVS52_21_WINNER_FINALE_REPLAY_BUTTON.md
docs/current/CURRENT_CHAT_HANDOFF_EVS52_26_WINNER_FINALE_NULLSAFE_PREVIEW.md
docs/current/CURRENT_CHAT_HANDOFF_EVS52_27_WINNER_TOP3_TWITCH_AVATARS_NO_AUTOREPLAY.md
docs/current/CURRENT_CHAT_HANDOFF_EVS52_3_TEXT_SOLVED_CELEBRATION_OVERLAY.md
docs/current/CURRENT_CHAT_HANDOFF_EVS52_4_TEXT_CHAT_OUTPUTS_ACTIVE.md
docs/current/CURRENT_CHAT_HANDOFF_EVS52_5_TEXT_LIVE_FLOW_FIX.md
docs/current/CURRENT_CHAT_HANDOFF_EVS52_6_LIVE_CHAT_DIRECT_BRIDGE.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS_10B_TEXT_RUNTIME_TEST_HELPERS.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS_11C_SAFEJSON_CHAT_OUTPUT_FIX.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS_16B_STATISTICS_TAB_LAYOUT_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_EVS_16C_TEXTS_TAB_MODULE_FILTER.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS_19C_PARALLEL_TEST_OPTIONS_FIX.md
docs/current/CURRENT_CHAT_HANDOFF_EVS_19D_PARALLEL_CONTEXT_EVENTUID_FIX.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS_1_EVENT_SYSTEM_PLANNING.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS_24A_DASHBOARD_STATUS_SIMPLIFY.md
docs/current/CURRENT_CHAT_HANDOFF_EVS_24B_STREAMER_FRIENDLY_LIFECYCLE_TEXT.md
docs/current/CURRENT_CHAT_HANDOFF_EVS_24_SIMPLE_ACTIVE_EVENT_RUNTIME_GATE.md
docs/current/CURRENT_CHAT_HANDOFF_EVS_25A_EMPTY_OVERVIEW_ACTION_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_EVS_25_OVERVIEW_ACTIVE_EVENT_STATUS.md
...
docs/current/CURRENT_CHAT_HANDOFF_EVS_7B_DASHBOARD_TABS_LAYOUT_SPLIT.md
docs/current/CURRENT_CHAT_HANDOFF_EVS_7C_EVENT_OVERVIEW_EDITOR_FLOW.md
docs/current/CURRENT_CHAT_HANDOFF_EVS_7_TEXT_CONFIG_DASHBOARD_PREP.md
docs/current/CURRENT_CHAT_HANDOFF_EVS_8B_EVENTBUS_HEARTBEAT_TODO_DOCS.md
...
docs/current/CURRENT_CHAT_HANDOFF_HYPETRAIN_HT3_0_2026-06-22.md
docs/current/CURRENT_CHAT_HANDOFF_HYPETRAIN_HT3_1_2026-06-22.md
...
docs/current/CURRENT_CHAT_HANDOFF_HYPETRAIN_TAGEBUCH_HT2_9_2026-06-22.md
...
docs/current/CURRENT_CHAT_HANDOFF_LC_LIVE_RAFFLE_AFTER_STREAM_2026-06-15.md
...
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GAMES_LWG_2.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GAMES_LWG_2_1.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GAMES_LWG_3.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GAMES_LWG_3_1.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GAMES_LWG_4B.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GAMES_LWG_4C.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GAMES_LWG_4C_1.md
...
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GIVEAWAYS_LWG_4I.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GIVEAWAYS_LWG_4I_1.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GIVEAWAYS_LWG_4J.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GIVEAWAYS_LWG_4J_1.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GIVEAWAYS_LWG_4J_2.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GIVEAWAYS_LWG_4K_1.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_GIVEAWAYS_LWG_4K_2.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_0A.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_0B.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_1.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_1B.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_2.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_3.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_3B.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_3C.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_4.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_5.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_5B.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_5C.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_5D.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_5E.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_LWG_4O_5E_TO_NEXT_CHAT.md
docs/current/CURRENT_CHAT_HANDOFF_LOYALTY_WHEEL_OVERLAY_LWG_4F_2.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4L_1.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4L_11.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4L_12.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4L_14.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4L_2.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4L_3.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4L_4.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4L_5.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4L_6.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4L_7.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4L_8.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4M_1.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4M_2.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4M_3.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4M_4.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4M_4_DOCUMENTED.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4M_5.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4M_8.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4M_9.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_0.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_1B.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_1C.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_2.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_3.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_3B.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_3C.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_4.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_5.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_5B.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_6.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_6B.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_6C.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_6D.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_6E.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_6F.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4N_7.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12G_LEGACY_GIVEAWAY_WHEEL_EDITOR_REDIRECT.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12H_LEGACY_GIVEAWAY_CODE_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12I_UNIFIED_LOYALTY_TABS_IN_GIVEAWAYS.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12J_FINAL_GIVEAWAYS_UI_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12K_GAMBLE_SINGLE_TEXT_VARIANT_FIX.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12L_GAMBLE_SIMPLE_WIN_LOSS_LOGIC.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12M_GAMBLE_CONFIG_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12N_FINAL_GAMBLE_GIVEAWAYS_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12O_GIVEAWAY_CONTROL_UI_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12P_GAMBLE_UI_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12Q_GIVEAWAY_WHEEL_EDITOR_UI_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q12R_DOCUMENTATION_AND_NEXT_CHAT.md
docs/current/CURRENT_CHAT_HANDOFF_LWG_4Q_11.md
...
docs/current/CURRENT_CHAT_HANDOFF_LWG_WHEEL_TEXT_RADIAL_5.md
docs/current/CURRENT_CHAT_HANDOFF_SHOT_ALARM_1.md
docs/current/CURRENT_CHAT_HANDOFF_SHOT_ALARM_2A.md
docs/current/CURRENT_CHAT_HANDOFF_SHOT_ALARM_2B.md
...
docs/current/CURRENT_CHAT_HANDOFF_SOUND_GAP_1.md
docs/current/CURRENT_CHAT_HANDOFF_SOUND_LOG_1.md
docs/current/CURRENT_CHAT_HANDOFF_SOUND_SAFE_1.md
docs/current/CURRENT_CHAT_HANDOFF_SOUND_SAFE_1B.md
docs/current/CURRENT_CHAT_HANDOFF_SO_SYNC_2026-06-21.md
docs/current/CURRENT_CHAT_HANDOFF_STEP211_LWG5_3.md
docs/current/CURRENT_CHAT_HANDOFF_STEP212A_LWG5_4a.md
...
docs/current/CURRENT_CHAT_HANDOFF_STEP218_LWG5_10.md
docs/current/CURRENT_CHAT_HANDOFF_STEP219_LWG6_0.md
docs/current/CURRENT_CHAT_HANDOFF_STEP220_LWG6_1.md
docs/current/CURRENT_CHAT_HANDOFF_STEP221_LWG6_2.md
docs/current/CURRENT_CHAT_HANDOFF_STEP222_LWG6_3.md
docs/current/CURRENT_CHAT_HANDOFF_STEP223_LWG6_4.md
docs/current/CURRENT_CHAT_HANDOFF_STEP224A_LWG6_5A.md
docs/current/CURRENT_CHAT_HANDOFF_STEP224_LWG6_5.md
...
docs/current/CURRENT_CHAT_HANDOFF_STEP230A_LWG7_1A.md
docs/current/CURRENT_CHAT_HANDOFF_STEP230_LWG7_1.md
docs/current/CURRENT_CHAT_HANDOFF_STEP231_LWG7_2.md
docs/current/CURRENT_CHAT_HANDOFF_STEP232_LWG7_3.md
docs/current/CURRENT_CHAT_HANDOFF_STEP233_PROJECT_AUDIT.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235A_DASHBOARD_SHELL_STABILIZE.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235B_REMOVE_STEP232_GAMBLE_SHELL.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235C_GAMBLE_TAB_IN_LOYALTY.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235D_LOYALTY_CONFIG_TAB_FOUNDATION.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235E_CONFIG_SAVE_UX_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235F_REMOVE_DRYRUN_FROM_GAMBLE_CONFIG_UI.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235G_CONFIG_RESULT_UX_CLEANUP.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235H_CONFIG_UX_STANDARD.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235J_REMOVE_STANDALONE_GAMBLE_DASHBOARD.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235M_REMOVE_LOYALTY_RUNTIME_SHELL_FALLBACK.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235P_GAMBLE_ACTOR_FIELDS_PREPARED.md
docs/current/CURRENT_CHAT_HANDOFF_STEP235R_GAMBLE_COOLDOWN_UX_CLEANUP.md
...
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_10_2_LIGHT_ADMIN_ACTIONS.md
...
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_14_3_LIVE_TEST_SUCCESS.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_14_4_VIP_REMOVE_SUCCESS.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_14_DESIGN05_OVERLAYSETS.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_15_1_NO_DASHBOARD_DOTS.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_15_OVERLAYSET_EDITOR.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_16_TEXTE_TAB.md
...
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_18_1_AUTO_SOUND_DURATION.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_18_2_AVATAR_RESOLVE.md
...
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_10_READABILITY_TUNE.md
...
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_16_DASHBOARD_TEXT_EDITOR.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_18_REWARD_LINK_LIVE_CHECK.md
...
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_23.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_2_EDITOR_PREVIEW.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_3_SIMPLE_NAME_POSITION_PREVIEW.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_4_SIMPLE_NAME_POSITION_EXACT_DESIGN.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_5_TEXT_SPACING_AND_USERNAME_STYLE.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_6_REFERENCE_EXTRACTED.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_7_NAME_PROMINENCE_COMPACT_SPACING.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_8_HEADLINE_STRONGER.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_19_9_HEADLINE_HIERARCHY.md
docs/current/CURRENT_CHAT_HANDOFF_VIP30_STEP8_7.md
...
docs/current/DASHBOARD_DIAGNOSTICS_REGISTRY_CAN42_21B.md
...
docs/current/DOCS_CLEANUP_2_DELETE_LIST.txt
...
docs/current/EMERGENCY_ROLLBACK_EVS52_21_STABLE.md
docs/current/EVS49_38_WINNER_FINALE_DOCS_HANDOFF.md
docs/current/EVS52_9_CHAT_DIAGNOSTIC_ANALYSIS.md
docs/current/FILES.md
docs/current/FILES_EVENT_SOUND_RUNTIME_2026-06-16.md
...
docs/current/HT2_9_HYPETRAIN_TAGEBUCH_POSTERNAME.md
docs/current/HT3_0_HYPETRAIN_EVENT_ACTIONS_OVERLAY_BASE.md
docs/current/HT3_1_HYPETRAIN_OVERLAY_REGISTER_HEARTBEAT.md
docs/current/HT3_2_1_HYPETRAIN_EVENT_SOUND_HAS_MEDIA_HOTFIX.md
docs/current/HT3_2_HYPETRAIN_EVENT_ACTION_CONFIG.md
docs/current/HT3_3_1_HYPETRAIN_DASHBOARD_EVENT_ACTIONS_TAB.md
docs/current/HT3_3_2_HYPETRAIN_DASHBOARD_EVENT_ACTIONS_TAB_ONLY.md
docs/current/HT3_3_3_HYPETRAIN_DASHBOARD_EVENT_ACTIONS_REAL_TAB_FIX.md
docs/current/HT3_3_HYPETRAIN_DASHBOARD_EVENT_ACTIONS.md
docs/current/HT3_4_HYPETRAIN_DASHBOARD_MERGE_CLEANUP.md
docs/current/HT3_5_1_HYPETRAIN_OVERLAY_BUS_WORDING.md
docs/current/HT3_5_2_HYPETRAIN_OVERLAY_ARCHITECTURE_WORDING.md
docs/current/HT3_5_HYPETRAIN_EVENT_ACTIONS_UX_CLEANUP.md
docs/current/HT3_6_HYPETRAIN_DASHBOARD_DIAGNOSE_WORDING_CLEANUP.md
docs/current/HT3_7_HYPETRAIN_MEDIA_PICKER_UPLOAD_INTEGRATION.md
...
docs/current/LC_CORE_POINTS_3A_DOC_UPDATE_README.md
docs/current/LC_CORE_POINTS_3D_DOC_UPDATE_NOTES.md
docs/current/LC_CORE_POINTS_3E_DOC_UPDATE_NOTES.md
docs/current/LC_DASHBOARD_INVENTORY_1_2026-06-15.md
docs/current/LWG_4L_12_TEST_COMMANDS.md
docs/current/LWG_4L_14_ACTIVATION_COMMANDS.md
docs/current/LWG_4L_7_TEST_COMMANDS.md
docs/current/LWG_4L_8_TEST_COMMANDS.md
docs/current/LWG_4M_2_TEST_COMMANDS.md
docs/current/LWG_4M_3_TEST_COMMANDS.md
docs/current/LWG_4M_4_TEST_COMMANDS.md
docs/current/LWG_4M_NEXT_STEPS.md
docs/current/LWG_COPY_BOUND_WHEEL_1_README.md
docs/current/LWG_DASHBOARD_COPY_BOUND_WHEEL_2_README.md
docs/current/LWG_DASHBOARD_COPY_BOUND_WHEEL_3_README.md
docs/current/LWG_DASHBOARD_COPY_BUTTON_4_README.md
docs/current/LWG_EVENING_COPY_EXCLUDE_1.md
docs/current/LWG_EVENING_FULL_FLOW_TEST_2_README.md
docs/current/LWG_EVENING_TESTS_README.md
docs/current/LWG_WHEEL_OVERLAY_RUNTIME_1_README.md
...
docs/current/NEW_CHAT_PROMPT_EVS_17B.md
...
docs/current/OVERLAY_MONITORING_CURRENT_STATUS.md
docs/current/OVERLAY_MONITORING_FILES.md
docs/current/OVERLAY_MONITORING_NEXT_STEPS.md
docs/current/OVERLAY_MONITORING_STEP620.md
docs/current/OVERLAY_MONITORING_STEP620B.md
docs/current/OVERLAY_MONITORING_STEP621.md
docs/current/OVERLAY_MONITORING_STEP621C.md
docs/current/OVERLAY_MONITORING_STEP621D.md
docs/current/OVERLAY_MONITORING_STEP624.md
docs/current/OVERLAY_MONITORING_STEP624B.md
docs/current/OVERLAY_MONITORING_STEP624C.md
docs/current/OVERLAY_MONITORING_STEP625A.md
docs/current/OVERLAY_MONITORING_STEP625B.md
docs/current/OVERLAY_MONITORING_STEP626A.md
docs/current/OVERLAY_MONITORING_STEP626B.md
docs/current/OVERLAY_MONITORING_STEP626D.md
docs/current/OVERLAY_MONITORING_STEP626E.md
docs/current/OVERLAY_MONITORING_STEP626F.md
docs/current/OVERLAY_MONITORING_STEP626G.md
docs/current/OVERLAY_MONITORING_STEP627.md
docs/current/OVERLAY_MONITORING_STEP627B.md
docs/current/OVERLAY_MONITORING_STEP627C.md
docs/current/OVERLAY_MONITORING_STEP628A.md
docs/current/OVERLAY_MONITORING_STEP628B.md
docs/current/OVERLAY_MONITORING_STEP628C.md
...
docs/current/OVERLAY_SOURCE_MONITORING_CONCEPT.md
...
docs/current/PROJECT_HANDOFF_NEXT_CHAT.md
...
docs/current/PROMPT_NEW_CHAT_EVS52_21_NEXT_MODULE.txt
docs/current/PROMPT_NEW_CHAT_EVS52_9_CHAT_UNIFICATION.txt
docs/current/README_CAN10_0_FILE_ZIP.md
docs/current/README_CAN10_1_FILE_ZIP.md
docs/current/README_CAN10_2_FILE_ZIP.md
docs/current/README_CAN10_3_FILE_ZIP.md
docs/current/README_CAN10_4_FILE_ZIP.md
docs/current/README_CAN10_5_FILE_ZIP.md
docs/current/README_CAN10_6_FILE_ZIP.md
docs/current/README_CAN10_7_FILE_ZIP.md
docs/current/README_CAN11_0_FILE_ZIP.md
docs/current/README_CAN11_1_FILE_ZIP.md
docs/current/README_CAN11_2_FILE_ZIP.md
docs/current/README_CAN11_3_FILE_ZIP.md
...
docs/current/README_CAN12_1_FILE_ZIP.md
docs/current/README_CAN12_2_FILE_ZIP.md
docs/current/README_CAN12_3_FILE_ZIP.md
docs/current/README_CAN12_4_FILE_ZIP.md
docs/current/README_CAN12_FINAL_FILE_ZIP.md
docs/current/README_CAN6_10_FILE_ZIP.md
docs/current/README_CAN6_1_FILE_ZIP.md
...
docs/current/README_CAN8_13_FILE_ZIP.md
...
docs/current/README_CAN8_5_1_FILE_ZIP.md
...
docs/current/README_CAN9_2_FILE_ZIP.md
docs/current/README_CAN9_3_FILE_ZIP.md
...
docs/current/README_CAN9_9_FILE_ZIP.md
docs/current/README_RESTORE_BACKEND19_DASHBOARD21.md
docs/current/README_STEP_LC_MINIGAMES_1B_DASHBOARD_TAB.md
docs/current/README_STEP_LC_MINIGAMES_1C_DASHBOARD_LAYOUT_CLEANUP.md
docs/current/README_STEP_LC_MINIGAMES_1D_RAFFLE_DETAIL_LAYOUT.md
docs/current/README_STEP_LC_MINIGAMES_DOCS_2026-06-15.md
docs/current/README_STEP_LC_RAFFLE_1.md
docs/current/README_STEP_LC_RAFFLE_1B.md
docs/current/README_STEP_LC_RAFFLE_1C.md
docs/current/README_STEP_LC_RAFFLE_1D.md
docs/current/README_STEP_LC_RAFFLE_1F.md
docs/current/README_STEP_LC_RAFFLE_2A_CONFIG_ROUTES.md
docs/current/README_STEP_LC_RAFFLE_2A_FIX1_CONFIG_ENDPOINT.md
...
docs/current/ROUTE_DIAGNOSTICS.md
docs/current/SERVER_LOG_MODULE_LOADING_RULES_2026-05-26.md
docs/current/SHOUTOUT_API_ROUTEN_INVENTUR_CAN44_21_R.md
docs/current/SHOUTOUT_CAN44_21_STATUS.md
docs/current/SHOUTOUT_CLIP_PLAYBACK_FALLBACK_CAN44_21_15.md
docs/current/SHOUTOUT_DASHBOARD_REBUILD_PLAN_CGN_DESIGN_NAV_CAN44_21_0_4.md
docs/current/SHOUTOUT_DASHBOARD_REBUILD_PLAN_DIAGNOSE_ABGRENZUNG_CAN44_21_0_1.md
docs/current/SHOUTOUT_DASHBOARD_REBUILD_PLAN_EINSTEIGERFREUNDLICHKEIT_CAN44_21_0_3.md
docs/current/SHOUTOUT_DASHBOARD_REBUILD_PLAN_ROLLEN_MODS_CAN44_21_0_2.md
docs/current/SHOUTOUT_RUNTIME_TEXTVARIANTEN_CAN44_21_14.md
docs/current/SHOUTOUT_TEXTVARIANTEN_CGN_ALTERSHEIM_CAN44_21_13.md
docs/current/SHOUTOUT_TEXT_SEED_CLEANUP_CAN44_21_13_2.md
docs/current/SHOUTOUT_V2_NEXT_STEPS_CAN44_21_12.md
docs/current/SHOUTOUT_V2_STATUS_CAN44_21_12.md
docs/current/SOUND_SYSTEM_STATUS_DIAGNOSTICS_CAN42_15.md
docs/current/START_HERE_RDAP5I_REMOTE_READONLY_LIVE.md
docs/current/STATS_REPORTS_CLEANUP_SUMMARY_CURRENT.md
docs/current/STEP279_HEARTBEAT_PLAN.md
docs/current/STEPDONE_WORKFLOW.md
docs/current/STEP_EVS52_22B_EMERGENCY_MERGED_RESTORE.md
...
docs/current/STEP_LC_SHELL_1_LOYALTY_CORE_SHELL_STICKY_NAV.md
docs/current/STEP_LC_TAB_1_LOYALTY_CORE_AS_TAB.md
...
docs/current/TEST_RESULTS_LWG_4Q_11.md
...
docs/current/TODO_EVENT_SOUND_DASHBOARD.md
docs/current/TODO_EVENT_SOUND_RUNTIME.md
docs/current/TODO_INTEGRATION_MAPPING_CAN42_4D.md
docs/current/TODO_INTEGRATION_RAW_COUNTS_CAN42_5C.md
docs/current/TODO_SOUND_DASHBOARD_RECENT_PLAYBACK.md
docs/current/TODO_STATUS_DIAGNOSTICS_STANDARD_CAN42_6.md
docs/current/TODO_STREAM_EVENTS_EVS49_38.md
...
<details>
<summary>DELETE_OR_REGENERATE (0)</summary>
...
<details>
<summary>REVIEW_MANUALLY (40)</summary>
