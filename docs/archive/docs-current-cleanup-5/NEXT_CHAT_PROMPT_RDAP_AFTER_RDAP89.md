# NEXT CHAT PROMPT - RDAP after RDAP89
...
- Agent-Actions werden spaeter nur per Allowlist und separatem Scope geplant.
```
...
```text
Ich lese zuerst die aktuellen Startdateien aus GitHub/dev und pruefe RDAP81 bis RDAP89 sowie die relevanten Runtime-Dateien. Danach nenne ich nur den Plan fuer RDAP90 Stream-PC-Verbindung Runtime-Accept disabled Build-Plan. Kein Code/ZIP vor deinem go.
```
