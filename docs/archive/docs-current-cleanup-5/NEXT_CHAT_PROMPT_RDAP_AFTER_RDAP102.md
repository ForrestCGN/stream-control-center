# NEXT CHAT PROMPT - RDAP after RDAP102
...
RDAP102 dokumentierte den Plan fuer sichtbaren Stream-PC Verbindungsstatus:

```text
- Bereich: Verbindungen.
- Kachel: Stream-PC Verbindung.
- Untertitel: Webserver <-> Stream-PC.
- Bestehende Route /api/remote/agent/status nutzen.
- Anzeige fuer verbunden/getrennt/veraltet, letzter Heartbeat, heartbeatAge, stale, Actions disabled.
...
```text
- Reine Read-only UI-Kachel fuer Stream-PC Verbindung vorbereiten.
- Bestehende /api/remote/agent/status Route nutzen.
- Nutzerfreundliche Bezeichnungen verwenden.
- Kein Start/Stop Button.
- Keine Agent-Actions.
...
2. Danach kurzen Plan fuer RDAP103 nennen.
