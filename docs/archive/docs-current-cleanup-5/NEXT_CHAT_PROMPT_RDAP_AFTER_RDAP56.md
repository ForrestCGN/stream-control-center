...
RDAP56 hat den naechsten Permission-Detail-Scope geplant.
...
RDAP56 war Plan-only/Doku-only.
...
2. Kurz bestaetigen, dass RDAP56 geplant/dokumentiert ist.
3. RDAP57 kurz planen.
4. Auf `go` warten.
