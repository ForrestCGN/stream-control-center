# NEXT_CHAT_PROMPT_RDAP_AFTER_RDAP50
...
```text
Frontend-only.
Bruecke User-Detail -> Admin-Notizen verbessern.
Button Admin-Notizen oeffnen setzt denselben Zieluser.
Admin-Notizen zeigt sichtbaren Kontext-Hinweis "Aus User-Detail geoeffnet".
Optional Ruecksprung "Zurueck zum User-Detail".
Keine zweite Notiz-Implementierung.
...
## Echte Dateien fuer RDAP51 zuerst pruefen
...
Nicht neue Backend-Route bauen, wenn vorhandene Frontend-APIs reichen.
