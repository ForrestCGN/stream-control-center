# NEXT CHAT PROMPT - RDAP after RDAP96
...
```text
- Lokale Checks auswerten.
- Agent-Dateien syntaktisch bestaetigen.
- npm --prefix remote-modboard/stream-pc-agent run check bestaetigen.
- Kein Webserver-Deploy, wenn nur Agent-Client und Doku geaendert wurden.
- Noch kein Live-Test ohne separaten Plan.
```

## Bitte jetzt

1. Erst die oben genannten Dateien wirklich aus GitHub/dev lesen.
2. Danach kurzen Plan fuer RDAP96B nennen.
