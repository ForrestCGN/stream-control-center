# NEXT_CHAT_PROMPT_RDAP_AFTER_RDAP117
...
Admin-Navigation: Benutzerverwaltung, Admin-Notizen, Verbindungen, Doku / Details.
System-Navigation: Übersicht, Diagnose.
Refresh: Doku/Details ohne sichtbaren Dauer-Refresh; Live-Statusseiten duerfen aktualisieren.
```
...
Ziel:
```text
Kurzer visueller Admin-/System-Navi-Review.
Letzte Dopplungen oder falsche Labels entfernen.
