# NEXT CHAT PROMPT - RDAP after RDAP97
...
RDAP97 ist dokumentiert:

```text
- Separater manueller Testplan fuer RDAP96-Agent-Client erstellt.
- Runtime soll im naechsten Live-Test nur temporaer aktiviert werden.
- Agent soll nur manuell gestartet werden.
...
Final bestaetigter Ausgangszustand bleibt:
...
2. Danach kurzen Plan fuer RDAP98 nennen.
3. Auf mein explizites `go` warten.
4. Keine Testbefehle vor `go`.
