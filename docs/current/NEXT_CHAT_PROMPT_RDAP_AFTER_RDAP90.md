# NEXT CHAT PROMPT - RDAP after RDAP90
...
- Heartbeat/Online/Actions bleiben getrennt.
...
```text
Ich lese zuerst die aktuellen Startdateien aus GitHub/dev und pruefe RDAP81 bis RDAP90 sowie die relevanten Runtime-Dateien. Danach nenne ich nur den Plan fuer RDAP91 Stream-PC-Verbindung Runtime-Accept Transport-disabled Code-Plan. Kein Code/ZIP vor deinem go.
```
