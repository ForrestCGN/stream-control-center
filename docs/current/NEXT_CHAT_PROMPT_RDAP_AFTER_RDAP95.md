# NEXT CHAT PROMPT - RDAP after RDAP95
...
```text
- Minimalen Stream-PC Agent Client als eigene Komponente vorbereiten.
...
## Voraussichtlicher Scope fuer RDAP96

Neue Agent-Komponente:
...
Nur wenn beim Lesen der echten Dateien nichts dagegen spricht.

## Strikt nicht machen in RDAP96
...
Wenn RDAP96 gebaut wird:

```text
- Erst lokal installstep.cmd.
- Syntaxchecks fuer neue Agent-Dateien.
- Kein Webserver-Deploy, wenn nur neue Agent-Client-Dateien unter remote-modboard/stream-pc-agent/ entstehen und Webserver-Code unveraendert bleibt.
- Live-/Runtime-Test nur separat und kurz.
- Bei Live-Test: Runtime temporaer aktivieren, danach final deaktivieren und Status pruefen.
- In Web-/SSH-Konsole keine riesigen kombinierten Paste-Bloecke verwenden.
```

## Bitte jetzt

1. Erst die oben genannten Dateien wirklich aus GitHub/dev lesen.
2. Danach kurzen Plan fuer RDAP96 nennen.
