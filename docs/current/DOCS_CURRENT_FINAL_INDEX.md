...
Diese Datei beschreibt den aktuellen Sollbestand von `docs/current/` nach RDAP124/RDAP125.
...
Step-Dokumente wie `RDAP122_...`, `RDAP123_...` und `RDAP124_...` koennen im Current-Bereich liegen, wenn sie als unmittelbare Handoff-/Nachweisdateien noch aktiv gebraucht werden. Bei spaeterem Cleanup gehoeren sie ins Archiv.
