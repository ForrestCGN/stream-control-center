# NEXT CHAT PROMPT - RDAP after RDAP83B
...
- statusApiVersion rdap_agent83.v1 bestaetigt.
...
```text
Ich lese zuerst die aktuellen Startdateien aus GitHub/dev und pruefe RDAP81/RDAP82/RDAP82B/RDAP83/RDAP83B sowie die relevanten Runtime-Dateien. Danach nenne ich nur den Plan fuer RDAP84 Stream-PC-Verbindung Access-Key-Handshake-Plan. Kein Code/ZIP vor deinem go.
```
