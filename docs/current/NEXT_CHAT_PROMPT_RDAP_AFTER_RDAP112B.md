# NEXT_CHAT_PROMPT_RDAP_AFTER_RDAP112B
...
RDAP112B: Sync-Fix; Routen aus normalem System-Menue raus; Details / System-Routen stark vereinfacht.
```
...
Technische Details nur ueber Info/extra Fenster oder Details/Admin-Bereich.
```
...
Ziel:
```text
Admin-Benutzerverwaltung weiter aus Shell/Normalansicht herausloesen.
