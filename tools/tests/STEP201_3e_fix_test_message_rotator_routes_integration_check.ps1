...
$Result = [ordered]@{
  ...
  tests = [ordered]@{
    ...
    legacyRoutes = Invoke-TestRequest -Name "legacyRoutes" -Url "http://127.0.0.1:8080/message-rotator/routes"
    legacyIntegrationCheck = Invoke-TestRequest -Name "legacyIntegrationCheck" -Url "http://127.0.0.1:8080/message-rotator/integration-check"
  }
}
