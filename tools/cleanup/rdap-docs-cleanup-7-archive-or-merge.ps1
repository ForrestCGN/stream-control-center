...
$archiveRoot = 'docs/archive/docs-current-cleanup-7'
...
Write-Host "RDAP Docs Cleanup 7 - Archive-or-Merge Manifest"
Write-Host "Repo root: $repoRoot"
Write-Host "Mode: $(if ($Execute) { 'EXECUTE' } else { 'DRY-RUN' })"
Write-Host "Move candidates: $($items.Count)"
...
if ($WriteReports) {
  $reportDir = Join-Path $repoRoot '_handoff\rdap-docs-cleanup-7-archive-or-merge'
  New-Item -ItemType Directory -Force -Path $reportDir | Out-Null
  $jsonPath = Join-Path $reportDir 'move-plan.json'
  $tsvPath = Join-Path $reportDir 'move-plan.tsv'
