...
$targetArchiveDirRel = "project-state/archive/2026-05-29-step558-module-meta-rules"
...
$reportTxt = Join-Path -Path $OutDir -ChildPath "step561_batch_b_module_meta_rules_archive_apply_report.txt"
$reportJson = Join-Path -Path $OutDir -ChildPath "step561_batch_b_module_meta_rules_archive_apply_report.json"
$manifestMd = Join-Path -Path $OutDir -ChildPath "step561_batch_b_module_meta_rules_archive_manifest.md"
...
$lines = @()
$lines += "STEP561 Batch B Module/Meta Rules Archive Apply Report"
$lines += "Generated: " + $timestamp
$lines += "ProjectRoot: " + $ProjectRoot
$lines += "Mode: " + $mode
$lines += "TargetArchiveDir: " + $targetArchiveDirRel
$lines += "Planned files: " + @($batchBFiles).Count
...
$manifest = @()
$manifest += "# STEP561 Batch B Module/Meta Rules Archive Manifest"
$manifest += ""
...
Write-Host ""
Write-Host "STEP561 Batch B Module/Meta Rules Archive fertig."
