...
$targetArchiveDirRel = "project-state/archive/2026-05-30-step563-communication-bus-contract"
...
$reportTxt = Join-Path -Path $OutDir -ChildPath "step566_communication_bus_archive_apply_report.txt"
$reportJson = Join-Path -Path $OutDir -ChildPath "step566_communication_bus_archive_apply_report.json"
$manifestMd = Join-Path -Path $OutDir -ChildPath "step566_communication_bus_archive_manifest.md"
...
$lines = @()
$lines += "STEP566 Communication Bus Archive Apply Report"
$lines += "Generated: " + $timestamp
$lines += "ProjectRoot: " + $ProjectRoot
$lines += "Mode: " + $mode
$lines += "TargetArchiveDir: " + $targetArchiveDirRel
$lines += "Planned files: " + @($batchCFiles).Count
...
$manifest = @()
$manifest += "# STEP566 Communication Bus Archive Manifest"
$manifest += ""
...
Write-Host ""
Write-Host "STEP566 Communication Bus Archive fertig."
