...
$reportTxt = Join-Path -Path $OutDir -ChildPath "step576_channelpoints_build_archive_apply_report.txt"
$reportJson = Join-Path -Path $OutDir -ChildPath "step576_channelpoints_build_archive_apply_report.json"
$manifestMd = Join-Path -Path $OutDir -ChildPath "step576_channelpoints_build_archive_manifest.md"
...
$lines = @()
$lines += "STEP576 Channelpoints Build Archive Apply Report"
...
$manifest = @()
$manifest += "# STEP576 Channelpoints Build Archive Manifest"
$manifest += ""
...
Write-Host ""
Write-Host "STEP576 Channelpoints Build Archive Apply fertig."
