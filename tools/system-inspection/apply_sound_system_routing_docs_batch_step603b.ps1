...
$targetDocRel = "docs/modules/sound_system_channelpoints_routing.md"
...
$sectionMarker = "<!-- STEP603B_SOUND_SYSTEM_ROUTING_DOCS_BATCH_START -->"
$sectionEnd = "<!-- STEP603B_SOUND_SYSTEM_ROUTING_DOCS_BATCH_END -->"
...
$section.Add("")
$section.Add("Dieser Abschnitt dokumentiert den Sound-/Routing-Anteil aus dem von STEP602 ermittelten Batch A_channelpoints.")
$section.Add("")
$section.Add("Channelpoints-Zeilen wurden bereits in STEP603A getrennt dokumentiert und werden hier nicht erneut vermischt.")
$section.Add("")
$section.Add("### Batch")
$section.Add("")
...
$section.Add("2. Sie beschreiben Doku-Bedarf fuer Sound-/Routing-nahe Module, keine neue Funktionalitaet.")
$section.Add("3. Sound-System, Queue, Prioritaeten, Outputs und Routing-Regeln duerfen dadurch nicht funktional veraendert werden.")
...
$section.Add("")
$section.Add("### Sound-/Routing-nahe Module in diesem Batch")
$section.Add("")
...
$section.Add("")
$section.Add("Dieser Abschnitt ist eine Doku-/Review-Zwischenablage fuer Sound-System-/Channelpoints-Routing-nahe Scan-Kandidaten.")
$section.Add("")
$section.Add("Er ersetzt keine fachliche Sound-System-Doku und trifft keine Aussage darueber, ob eine Route produktiv, intern, diagnostisch oder historisch ist.")
$section.Add("")
$section.Add("### Naechster Schritt")
$section.Add("")
$section.Add("STEP604 - Channelpoints/Sound Routing Batch Verification")
$section.Add("")
$section.Add("Ziel: Pruefen, ob STEP603A und STEP603B sauber getrennt dokumentiert wurden und danach den naechsten Modul-Doku-Batch bestimmen.")
$section.Add("")
...
if (@($errors).Count -eq 0) {
  if (Test-Path -LiteralPath $targetDocPath) {
    ...
    $content = "# Sound System Channelpoints Routing`n"
  }
...
$summaryPath = Join-Path $OutDir "step603b_sound_system_routing_docs_batch_summary.txt"
$rowsOutTsv = Join-Path $OutDir "step603b_sound_system_routing_docs_batch_rows.tsv"
$jsonPath = Join-Path $OutDir "step603b_sound_system_routing_docs_batch.json"
...
$summary = @()
$summary += "STEP603B Sound System Routing Docs Batch Summary"
...
Write-Host ""
Write-Host "STEP603B Sound System Routing Docs Batch fertig."
