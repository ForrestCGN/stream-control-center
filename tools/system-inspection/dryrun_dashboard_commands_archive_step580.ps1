...
$reportTxt = Join-Path -Path $OutDir -ChildPath "step580_dashboard_commands_archive_dryrun.txt"
$reportJson = Join-Path -Path $OutDir -ChildPath "step580_dashboard_commands_archive_dryrun.json"
$summaryTxt = Join-Path -Path $OutDir -ChildPath "step580_dashboard_commands_archive_dryrun_summary.txt"
$manifestMd = Join-Path -Path $OutDir -ChildPath "step580_dashboard_commands_archive_manifest.md"
...
$lines = @()
$lines += "STEP580 Dashboard Commands Archive Dry-Run"
...
$summary = @()
$summary += "STEP580 Dashboard Commands Archive Dry-Run Summary"
$summary += "Generated: " + $timestamp
$summary += "Mode: DRY_RUN_ONLY"
$summary += "TargetArchiveDir: " + $targetArchiveDirRel
$summary += "Planned files: " + @($dashboardCommandsFiles).Count
...
$summary += "STEP581 - Dashboard Commands Archive Apply"
$summary | Out-File -FilePath $summaryTxt -Encoding UTF8

$manifest = @()
$manifest += "# STEP580 Dashboard Commands Archive Manifest"
$manifest += ""
...
Write-Host ""
Write-Host "STEP580 Dashboard Commands Archive Dry-Run fertig."
