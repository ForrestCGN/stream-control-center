...
$reportTxt = Join-Path -Path $OutDir -ChildPath "step571_shoutout_archive_apply_report.txt"
$reportJson = Join-Path -Path $OutDir -ChildPath "step571_shoutout_archive_apply_report.json"
$manifestMd = Join-Path -Path $OutDir -ChildPath "step571_shoutout_archive_manifest.md"
...
$lines = @()
$lines += "STEP571 Shoutout Archive Apply Report"
...
$manifest = @()
$manifest += "# STEP571 Shoutout Archive Manifest"
$manifest += ""
...
Write-Host ""
Write-Host "STEP571 Shoutout Archive Apply fertig."
