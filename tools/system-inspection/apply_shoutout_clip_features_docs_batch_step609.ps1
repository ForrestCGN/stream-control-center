...
$targetDocRel = "docs/system-inspection/SHOUTOUT_SYSTEM_CONSOLIDATION.md"
...
if (-not (Test-Path -LiteralPath $nextRowsTsv)) {
  $errors += "Missing input file: step608_next_real_module_doc_batch_rows.tsv"
}
...
$sectionMarker = "<!-- STEP609_SHOUTOUT_CLIP_FEATURES_DOCS_BATCH_START -->"
$sectionEnd = "<!-- STEP609_SHOUTOUT_CLIP_FEATURES_DOCS_BATCH_END -->"

$section = New-Object System.Collections.Generic.List[string]
$section.Add("")
$section.Add($sectionMarker)
$section.Add("")
$section.Add("## STEP609 Shoutout / Clip Features Module Docs Batch")
$section.Add("")
$section.Add("Stand: 2026-05-30")
$section.Add("")
$section.Add("Dieser Abschnitt dokumentiert den Shoutout-/Clip-Feature-Anteil aus dem von STEP608 bestimmten naechsten Modul-Doku-Batch.")
$section.Add("")
$section.Add("### Batch")
$section.Add("")
...
$section.Add("Quelle: system-scan-output/step608_next_real_module_doc_batch_rows.tsv")
$section.Add("Generated: " + $timestamp)
$section.Add("")
$section.Add("### Arbeitsregel")
$section.Add("")
$section.Add("1. Diese Eintraege sind scan-/triagebasiert.")
$section.Add("2. Sie beschreiben Doku-Bedarf fuer Shoutout-/Clip-nahe Module, keine neue Funktionalitaet.")
$section.Add("3. Bestehende produktive Shoutout-/Clip-Flows duerfen dadurch nicht geaendert werden.")
$section.Add("4. Keine produktive Route ungeprueft aus Scan-Treffern ableiten.")
$section.Add("5. Echte Moduldatei und Router-Kontext bleiben massgeblich.")
$section.Add("")
$section.Add("### Shoutout-/Clip-nahe Module in diesem Batch")
$section.Add("")
...
$section.Add("")
$section.Add("Dieser Abschnitt ist eine Doku-/Review-Zwischenablage fuer Shoutout-/Clip-nahe Scan-Kandidaten.")
$section.Add("")
$section.Add("Er ersetzt keine fachliche Shoutout- oder Clip-System-Doku und trifft keine Aussage darueber, ob eine Route produktiv, intern, diagnostisch oder historisch ist.")
$section.Add("")
$section.Add("### Naechster Schritt")
$section.Add("")
$section.Add("STEP610 - Shoutout / Clip Features Batch Verification")
$section.Add("")
$section.Add("Ziel: Pruefen, ob der STEP609-Abschnitt sauber in der Shoutout-System-Konsolidierungsdoku steht und danach die verbleibenden Doku-Batches bestimmen.")
$section.Add("")
...
if (@($errors).Count -eq 0) {
  if (Test-Path -LiteralPath $targetDocPath) {
    ...
    $content = "# Shoutout System Consolidation`n"
  }
...
$summaryPath = Join-Path $OutDir "step609_shoutout_clip_features_docs_batch_summary.txt"
$rowsOutTsv = Join-Path $OutDir "step609_shoutout_clip_features_docs_batch_rows.tsv"
$jsonPath = Join-Path $OutDir "step609_shoutout_clip_features_docs_batch.json"
...
$summary = @()
$summary += "STEP609 Shoutout / Clip Features Module Docs Batch Summary"
...
Write-Host ""
Write-Host "STEP609 Shoutout / Clip Features Module Docs Batch fertig."
