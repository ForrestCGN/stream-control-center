...
const MODULE_BUILD = 'RDAP_ADMIN_USERS24_AUTH_SESSION_OAUTH_READINESS_DIAGNOSTIC';
...
async function main() {
  ...
  const server = app.listen(config.port, config.host, () => {
    ...
    console.log('[remote-modboard] auth-session-oauth-readiness-diagnostic=true admin-note-read-permission-diagnostic=true read-only-ui=true remoteWrites=false agentActions=false');
  });
