...
const BUILD_NAME = 'OBS Inventory Sync Readonly';
const STEP_REF = 'RDAP_0.2.22_OBS_INVENTORY_SYNC_READONLY';
...
async function main() {
  ...
  const server = app.listen(config.port, config.host, () => {
    ...
    console.log('[remote-modboard] runtimeMode=' + config.runtimeMode + ' obsInventorySyncReadOnlyPrepared=true obsAllowlistRightsModelPrepared=true obsLiveStateReadOnlyPrepared=true obsInventoryUiDisplayPrepared=true actions=false remoteWritesControlled=true');
  });
