  ...
  app.get('/api/remote/status', async (req, res) => {
    ...
    res.json({
      ...
      auth: {
        ...
        notes: [
          'RDAP_ADMIN_USERS8 bereitet einen Audit-Helper vor, aber Audit-/Admin-Writes bleiben deaktiviert.',
          ...
          'RDAP6/RDAP7 Write-Foundation/Confirm-Diagnosen bleiben read-only verfuegbar.',
