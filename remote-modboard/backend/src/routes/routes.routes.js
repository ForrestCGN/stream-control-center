  ...
  app.get('/api/remote/routes', (req, res) => {
    res.json({
      ...
      routes: [
        ...
        { method: 'GET', path: '/api/remote/auth/readiness-diagnostic', description: 'Read-only RDAP24 Auth-/Session-/OAuth-Readiness; aktiviert nichts und schreibt nichts' },
        ...
        { method: 'GET', path: '/api/remote/admin/users/admin-notes/read', description: 'Read-only RDAP27 echte Admin-Notiztexte; nur mit Session, DashboardAccess und admin.users.note.read' },
      ...
      authSessionOauthReadinessDiagnostic: {
        prepared: true,
        ...
        aliasOf: 'authSessionsOauthReadinessDiagnostic'
      },
      authSessionsOauthReadinessDiagnostic: {
        prepared: true,
        route: '/api/remote/auth/readiness-diagnostic',
        readOnly: true,
        writeEnabled: false,
      ...
      adminUserAdminNoteRealReadAuthed: {
        ...
        uiWriteButtonsEnabled: false,
        routeListKeySynced: true,
        aliasOf: 'adminUsersAdminNoteRealReadAuthed'
      },
      adminUsersAdminNoteRealReadAuthed: {
        prepared: true,
        route: '/api/remote/admin/users/admin-notes/read',
        permissionKey: 'admin.users.note.read',
        tableName: 'dashboard_user_admin_notes',
