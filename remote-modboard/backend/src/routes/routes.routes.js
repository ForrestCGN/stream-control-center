  ...
  app.get('/api/remote/routes', (req, res) => {
    res.json({
      ...
      routes: [
        ...
        { method: 'GET', path: '/api/remote/admin/users/write-foundation-diagnostic', description: 'Read-only Confirm-/Audit-/Locking-Foundation fuer spaetere Admin-Writes; schreibt nichts' },
