  ...
  app.get('/api/remote/routes', (req, res) => {
    res.json({
      ...
      routes: [
        ...
        { method: 'GET', path: '/api/remote/admin/users/admin-note-read-permission-diagnostic', description: 'Read-only RDAP20 Admin-Notiz-Read-Permission-Diagnose; prueft admin.users.note.read, keine Notiztexte, keine Writes' },
      ...
      adminUsersAdminNoteReadPermissionDiagnostic: {
        prepared: true,
        route: '/api/remote/admin/users/admin-note-read-permission-diagnostic',
        permissionKey: 'admin.users.note.read',
        tableName: 'dashboard_user_admin_notes',
