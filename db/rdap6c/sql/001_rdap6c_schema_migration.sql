-- RDAP6C Auth DB Schema Migration Package
-- Stand: 2026-06-23
-- Zweck: vorbereitete SQL-Migration fuer spaeteren Einsatz.
...
INSERT INTO schema_migrations (migration_key, version, status, notes)
VALUES ('rdap6c_auth_db_schema', 'RDAP6C', 'prepared', 'Schema package prepared. Mark as applied only after real migration procedure.')
ON DUPLICATE KEY UPDATE version=VALUES(version), notes=VALUES(notes);
